...
CSV_FIELDS = ("id", "kind", "group", "task", "seed", "cfg", "steps", "resolution", "preprocess", "status", "validation_passed", *METRICS, *SCORE_FIELDS, *FLAG_FIELDS)
...
def load_run(directory: Path, root: Path, overrides: dict):
    ...
    images = {}
    for name in ("input_original", "input_model", "output", "output_content", "normal", "depth", "skeleton", "contact"):
