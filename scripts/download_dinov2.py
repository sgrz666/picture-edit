...
TARGET_DIR = Path("/home/shangguanrz/project/pic-edit/models/dinov2-giant")
TARGET_DIR.mkdir(parents=True, exist_ok=True)

BASE_URL = "https://huggingface.co/facebook/dinov2-giant/resolve/main"
