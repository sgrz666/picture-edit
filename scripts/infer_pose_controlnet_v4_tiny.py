...
from pose_control.deepgen_pose_controlnet_v4 import (
...
def main():
    ...
    print("===== BUILD CONTROLNET V4 =====")

    controlnet_v4 = DeepGenPoseControlNetV4(
    ...
    controlnet_v4.load_state_dict(
        checkpoint["controlnet_v4"],
        strict=True,
    )
    ...
    def wrapped_forward(
        ...
        **forward_kwargs,
        ...
        current_pose_map = pose_map

        if pose_map.shape[0] != batch_size:
            current_pose_map = pose_map.repeat(
                batch_size,
                1,
                1,
                1,
        ...
        residuals = controlnet_v4(
            target_latents=hidden_states,
            pose_map=current_pose_map,
    ...
    print(
        "Pose ControlNet V4 inference: PASS"
    )
