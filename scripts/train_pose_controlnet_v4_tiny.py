...
from pose_control.deepgen_pose_controlnet_v4 import DeepGenPoseControlNetV4
...
def save_checkpoint(
    ...
    path = (
        output_dir
        / f"controlnet_v4_step_{step:06d}.pt"
    )
    ...
    torch.save(
        {
            "step": step,
            "identity": identity,
            "controlnet_v4": adapter.state_dict(),
...
def main():
    ...
    adapter = DeepGenPoseControlNetV4(
    ...
    print(
        "\nPose ControlNet V4 trainable params:",
        f"{trainable_params:,}",
    )
